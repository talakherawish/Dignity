...
const FELLOWS: Fellow[] = [
  ...
  },
  {
    ...
    bioAr: "طالبة جامعية تدرس علم الحاسوب. انضمت إلى مبادرة الكرامة عام 2026 وساهمت في تطوير الموقع الذي تراه اليوم.",
    photo: talaPhoto,
  },
  {
    id: 6,
    ...
    bioAr: "أستاذة مشاركة متخصصة في الفلسفة السياسية ونظرية حقوق الإنسان، وهي عضو أساسي في مبادرة الكرامة منذ تأسيسها.",
    photo: undefined,
  },
  {
    id: 7,
    ...
    bio: "Dr. Zreik is a senior researcher whose work focuses on the philosophy of law, colonialism, and dignity. Author of Kant's Struggle for Independence, published by Lexington Publishing House.",
    bioAr: "باحث أول يتمحور عمله حول فلسفة القانون والاستعمار والكرامة. مؤلف كتاب 'كفاح كانط من أجل الاستقلال' الصادر عن دار ليكسينغتون للنشر.",
    photo: undefined,
  },
  {
    id: 8,
...
function FellowModal({ fellow, onClose, isArabic, lang }: {
  ...
  return (
    ...
    >
      {/* Outer wrapper — gives space for photo to float above */}
      <div className="relative w-full max-w-sm" style={{ paddingTop: "96px" }}>

        {/* Floating photo — sits above the card */}
  ...
  return (
    <PageLayout>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {/* Fellows grid — 3 cols on desktop, 2 on tablet */}
        {filtered.length > 0 ? (
