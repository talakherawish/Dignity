  ...
  return (
    ...
    >
      {/* Avatar floating on top, everything below it centered -- a
          ...
          centered layout otherwise. Matches TeamModal on the homepage. */}
      <div
        className="relative w-full max-w-2xl"
        style={{ paddingTop: participant.photo ? "112px" : "0px" }}
      >
        {participant.photo && (
        ...
        >
          ...
          <div className="px-8 pb-8" style={{ paddingTop: participant.photo ? "116px" : "48px" }}>
