        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-10 text-center">
          ...
          <div className="grid grid-cols-3 gap-5 sm:gap-10 lg:gap-14 max-w-3xl mx-auto">
            {members.map((person, idx) => (
              ...
              >
                <div className="h-24 w-24 sm:h-40 sm:w-40 lg:h-48 lg:w-48 rounded-full overflow-hidden bg-secondary shadow-sm ring-1 ring-border group-hover:ring-accent/40 transition-all duration-200">
                  {person.photo ? (
                    <img
                      src={person.photo}
                      alt={person.name}
                    ...
                    <div className="flex h-full w-full items-center justify-center font-serif text-2xl sm:text-4xl text-muted-foreground">
