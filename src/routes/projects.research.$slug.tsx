...
function ResearchDetailPage() {
  ...
  const body = (() => {
    const full = extractText(
      lang === "ar" ? (research.contentAr ?? research.content) : research.content,
    );
      ...
      >
        ...
        {(books.length > 0 ||
          ...
          <section className="mt-16">
            <div
              className={"flex items-center gap-2.5 mb-8" + (isArabic ? " flex-row-reverse" : "")}
            >
            ...
            {papers.length > 0 && (
              <div className="mb-12">
                <h3 className="font-serif text-2xl md:text-3xl text-primary mb-6">
                  {isArabic ? "الأوراق البحثية" : "Papers"}
                </h3>
                <div className="flex flex-wrap justify-center gap-6" dir={isArabic ? "rtl" : "ltr"}>
                  {papers.map((p) => {
                    const fileUrl = p.file ? mediaUrl(p.file) : "";
            ...
            {theses.length > 0 && (
              <div className="mb-12">
                <h3 className="font-serif text-2xl md:text-3xl text-primary mb-6">
                  {isArabic ? "الرسائل العلمية" : "Theses"}
                </h3>
                <div className="flex flex-wrap justify-center gap-6" dir={isArabic ? "rtl" : "ltr"}>
                  {theses.map((p) => {
                    const previewUrl =
            ...
            {audiovisual.length > 0 && (
              <div className="mb-12">
                <h3 className="font-serif text-2xl md:text-3xl text-primary mb-6">
                  {isArabic ? "محتوى مرئي" : "Audiovisual"}
                </h3>
                <div className="flex flex-wrap justify-center gap-6" dir={isArabic ? "rtl" : "ltr"}>
                  {audiovisual.map((p) => {
                    const previewUrl =
            ...
            {clippings.length > 0 && (
              <div className="mb-12">
                <h3 className="font-serif text-2xl md:text-3xl text-primary mb-6">
                  {isArabic ? "قصاصات صحفية" : "Press Clippings"}
                </h3>
                <div className="flex flex-wrap justify-center gap-6" dir={isArabic ? "rtl" : "ltr"}>
